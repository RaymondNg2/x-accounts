...
public final class JSONParser {
    ...
    private int peekStatus(final Stack<Integer> statusStack) {
    ...
    /**
     * Parse a JSON input into a Java object.
     * 
     * @param in
     *            The input to read from.
     * @return The parsed object.
     * @throws IOException
     *             When there was a problem reading from the input.
     */
    public Object parse(final Reader in) throws IOException {
        final Stack<Integer> statusStack = new Stack<>();
        final Stack<Object> valueStack = new Stack<>();
        final Yylex lexer = new Yylex(in);
        Yytoken token = null;
        int status = S_INIT;
