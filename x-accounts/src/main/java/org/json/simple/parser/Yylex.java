...
/**
 * The tokenizer for JSON objects.
 * 
...
final class Yylex {
    ...
    private final BufferedReader yy_reader;
     ...
     * 
     * @param reader
     *            The reader to tokenize from.
     */
    Yylex(final Reader reader) {
        super();
    ...
    private static final String yy_error_string[] = {
            "Error: Internal error.\n", "Error: Unmatched input.\n" };

    private void yy_error(final int code, final boolean fatal) {
        err.println("JSON parser error: " + yy_error_string[code]);
        if (fatal) {
            throw new Error("Fatal Error: " + yy_error_string[code]);
        }
    }

    private static int[][] unpackFromString(final int size1, final int size2,
            String st) {
        int colonIndex = -1;
        String lengthString;
    ...
    private static final int yy_acpt[] = { /* 0 */YY_NOT_ACCEPT,
            /* 1 */YY_NO_ANCHOR, /* 2 */YY_NO_ANCHOR, /* 3 */YY_NO_ANCHOR,
            /* 4 */YY_NO_ANCHOR, /* 5 */YY_NO_ANCHOR, /* 6 */YY_NO_ANCHOR,
            /* 7 */YY_NO_ANCHOR, /* 8 */YY_NO_ANCHOR, /* 9 */YY_NO_ANCHOR,
            /* 10 */YY_NO_ANCHOR, /* 11 */YY_NO_ANCHOR, /* 12 */YY_NO_ANCHOR,
            /* 13 */YY_NO_ANCHOR, /* 14 */YY_NO_ANCHOR, /* 15 */YY_NO_ANCHOR,
            /* 16 */YY_NO_ANCHOR, /* 17 */YY_NO_ANCHOR, /* 18 */YY_NO_ANCHOR,
            /* 19 */YY_NO_ANCHOR, /* 20 */YY_NO_ANCHOR, /* 21 */YY_NO_ANCHOR,
            /* 22 */YY_NO_ANCHOR, /* 23 */YY_NO_ANCHOR, /* 24 */YY_NO_ANCHOR,
            /* 25 */YY_NOT_ACCEPT, /* 26 */YY_NO_ANCHOR, /* 27 */YY_NO_ANCHOR,
            /* 28 */YY_NOT_ACCEPT, /* 29 */YY_NOT_ACCEPT, /* 30 */YY_NOT_ACCEPT,
            /* 31 */YY_NOT_ACCEPT, /* 32 */YY_NOT_ACCEPT, /* 33 */YY_NOT_ACCEPT,
            /* 34 */YY_NOT_ACCEPT, /* 35 */YY_NOT_ACCEPT, /* 36 */YY_NOT_ACCEPT,
            /* 37 */YY_NOT_ACCEPT, /* 38 */YY_NOT_ACCEPT, /* 39 */YY_NOT_ACCEPT,
            /* 40 */YY_NOT_ACCEPT, /* 41 */YY_NOT_ACCEPT, /* 42 */YY_NOT_ACCEPT,
            /* 43 */YY_NOT_ACCEPT, /* 44 */YY_NOT_ACCEPT };
     ...
     * @throws IOException
     *             Then the input stream could not be read.
     */
